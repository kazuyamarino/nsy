...
namespace Libraries\AssetManager;

use Libraries\AssetManager\NSY_AssetManager;
...
Class Assets extends NSY_AssetManager {
	...
	function pull_header_assets()
	{
		...
		// Foundation CSS
		$this->link_css('foundation.min', 'stylesheet', 'text/css');
		$this->link_css('responsive-tables.min', 'stylesheet', 'text/css');

		// Datatables CSS
		$this->link_css('dataTables.foundation.min', 'stylesheet', 'text/css');
