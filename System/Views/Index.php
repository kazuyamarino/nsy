<div class="wrap">
	<div style="text-align:center">
		...
		<div>
			...
			<div>
				<h4><a target="_blank" href="https://github.com/kazuyamarino/nsy-docs/blob/master/README.md#user-guide-"><strong>NSY User Guide</strong></a>&nbsp;<&nbsp;<code>The guide before starting to use NSY.</code></h4>
			</div>
			<div>
				<h4><a target="_blank" href="https://github.com/kazuyamarino/nsy-docs/blob/master/README.md#system-guide-"><strong>NSY Sistem Guide</strong></a>&nbsp;<&nbsp;<code>The guide system.</code></h4>
			</div>
		</div>
